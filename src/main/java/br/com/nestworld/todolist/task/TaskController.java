...
import br.com.nestworld.todolist.utils.Utils;
...
public class TaskController {
    ...
    @PostMapping("/")
    public ResponseEntity<T> create(@RequestBody TaskModel taskModel,HttpServletRequest request){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<T> update(@RequestBody TaskModel taskModel,HttpServletRequest request, @PathVariable UUID id){
